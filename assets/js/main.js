window.onload = () => {
	...
	const dummyArray = fetchData("dummy");

	// function jsonRequest(fileName) {
	// 	try {
	// 		let res = fetch(`./assets/data/${fileName}.json`);
	// 		return res.json();
	// 	} catch (error) {
	// 		console.error(error);
	// 	}
	...
	// 	jsonRequest(fileName).then((data) => {
	// 		console.log(data);
	// 		localStorage.setItem(`${fileName}Local`, JSON.stringify(data));
	// 		// console.log(data);
	// 	});
